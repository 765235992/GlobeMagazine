...
- (LJHShufflingCell *)leftCell
{
    if (!_leftCell) {
        ...
        self.leftCell = [[LJHShufflingCell alloc] initWithFrame:CGRectMake(0, 0,myWidth+1, myHeight) andDefaultImage:_defaultImage];
...
- (LJHShufflingCell *)centerCell
{
    if (!_centerCell) {
        ...
        self.centerCell = [[LJHShufflingCell alloc] initWithFrame:CGRectMake(myWidth, 0,myWidth+1, myHeight) andDefaultImage:_defaultImage];
...
- (LJHShufflingCell *)rightCell
{
    if (!_rightCell) {
        ...
        self.rightCell = [[LJHShufflingCell alloc] initWithFrame:CGRectMake(myWidth * 2 , 0,myWidth+1, myHeight) andDefaultImage:_defaultImage];
